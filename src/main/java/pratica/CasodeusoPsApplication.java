...
import pratica.domain.Cidade;
import pratica.domain.Cliente;
import pratica.domain.Endereco;
import pratica.domain.Estado;
import pratica.domain.ItemPedido;
import pratica.domain.Pagamento;
import pratica.domain.PagamentoComBoleto;
import pratica.domain.PagamentoComCartao;
...
import pratica.repositories.CidadeRepository;
import pratica.repositories.ClienteRepository;
import pratica.repositories.EnderecoRepository;
import pratica.repositories.EstadoRepository;
import pratica.repositories.ItemPedidoRepository;
import pratica.repositories.PagamentoRepository;
...
public class CasodeusoPsApplication implements CommandLineRunner{ 
	...
	public void run(String... args) throws Exception {
		...
		Estado est1 = new Estado(null, "Minas Gerais", null); //null
		Estado est2 = new Estado(null, "São Paulo", null); //null
		...
		estadoRepository.saveAll(Arrays.asList(est1,est2)); //primeiro salvamos o estado, pq não existe cidade sem estado
